...
public enum TileTarget: Hashable, Sendable {
    ...
    /// A folder containing other tiles, identified by folder UUID.
    ...
    public init(kind: TileKind, value: String) {
        ...
        case .folder: self = .folder(id: value)
        }
    }
...
/// A folder that holds tiles. Stored separately in the Deck.
public struct TileFolder: Identifiable, Codable, Hashable, Sendable {
    public var id: UUID
    ...
    public var isFull: Bool { tiles.count >= Self.maxTiles }
}
